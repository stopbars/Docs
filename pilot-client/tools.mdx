...
- You are spawned at an airport [supported](https://stopbars.com/status) by BARS
...
<Step title="Upload your XML">
  ...
  <Frame>
    <img
      ...
      alt="Contribution XML card showing the uploaded XML file and Open in BARS Pilot Client button"
    />
  </Frame>
</Step>
